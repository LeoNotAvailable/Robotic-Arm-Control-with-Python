from ModeloIABrazoRobótico import speak, ask_local, main_write, transcribe_audio, save_record, main, change_command_form, translate, ensure_sequence_file
...
servo_labels = ["Base", "Shoulder", "Elbow", "Wrist", "Gripper"] # Aquí s'afegeix el canell (wrist)
