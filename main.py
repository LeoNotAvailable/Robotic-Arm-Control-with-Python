...
"""This is the code that must be into the microcontroller (in my case, an ESP32 STEAMakers, I don't know if using a different one will cause any problem)
   If you have never programmed a microcontroller with python, I recommend you to use Thonny to pass the code. You'll probably need some sort of
   port controller before you can pass information through it. The best way of knowing how to do so is asking an ai as GPT."""
