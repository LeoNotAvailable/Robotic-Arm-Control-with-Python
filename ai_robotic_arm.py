...
pygame.mixer.init()
client= Groq(api_key="Here goes your api key") # You must introduce your own API keys.
api_key_llm = "Here goes your api key"
...
def ask_local(task):
    ...
    url = "http://localhost:-----/api/generate" # Add your lokalhost
    data = {
